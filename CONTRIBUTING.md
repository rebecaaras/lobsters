...
* On your personal computer, you probably want to add some sample data:
  ...
  The [default password](https://github.com/lobsters/lobsters/blob/7145244cce32b30f674ec815985a5da6233e5731/lib/tasks/fake_data.rake#L55) for users generated by `fake_data` is `"fake"`.
